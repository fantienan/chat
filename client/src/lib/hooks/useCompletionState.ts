...
function debounce<T extends (...args: any[]) => PromiseLike<void>>(func: T, wait: number): (...args: Parameters<T>) => void {
...
export function useCompletionState(
  ...
  const requestCompletions = useCallback(
    debounce(async (ref: ResourceReference | PromptReference, argName: string, value: string) => {
